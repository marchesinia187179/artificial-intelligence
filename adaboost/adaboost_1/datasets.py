...
def two_moon_dataset(n_samples=100, shuffle=True, noise=None, random_state=None):
    ...
    tuple
        a tuple like:
            ...
            Y_test ndarray shape: (n_samples,).
    """
    X_train, Y_train = make_moons(n_samples=n_samples, shuffle=shuffle, noise=noise, random_state=random_state)
    X_test, Y_test = make_moons(n_samples=n_samples, shuffle=shuffle, noise=noise, random_state=random_state)
